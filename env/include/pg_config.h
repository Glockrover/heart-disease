...
#define CONFIGURE_ARGS " '--prefix=/home/glockrover/Desktop/heart-disease-project/env' '--with-readline' '--with-libraries=/home/glockrover/Desktop/heart-disease-project/env/lib' '--with-includes=/home/glockrover/Desktop/heart-disease-project/env/include' '--with-openssl' '--with-gssapi' '--with-icu' '--with-libxml' '--with-libxslt' '--with-lz4' '--with-zstd' '--with-uuid=e2fs' '--with-system-tzdata=/home/glockrover/Desktop/heart-disease-project/env/share/zoneinfo' '--with-ldap' 'PG_SYSROOT=undefined' 'build_alias=x86_64-conda-linux-gnu' 'host_alias=x86_64-conda-linux-gnu' 'CC=x86_64-conda-linux-gnu-cc' 'CFLAGS=-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/glockrover/Desktop/heart-disease-project/env/include -fdebug-prefix-map=/croot/postgresql-split_1741123568549/work=/usr/local/src/conda/postgresql-split-17.4 -fdebug-prefix-map=/home/glockrover/Desktop/heart-disease-project/env=/usr/local/src/conda-prefix' 'LDFLAGS=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/home/glockrover/Desktop/heart-disease-project/env/lib -Wl,-rpath-link,/home/glockrover/Desktop/heart-disease-project/env/lib -L/home/glockrover/Desktop/heart-disease-project/env/lib' 'CPPFLAGS=-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/glockrover/Desktop/heart-disease-project/env/include' 'CXX=' 'CPP=/croot/postgresql-split_1741123568549/_build_env/bin/x86_64-conda-linux-gnu-cpp' 'PKG_CONFIG_PATH=/home/glockrover/Desktop/heart-disease-project/env/lib/pkgconfig'"
